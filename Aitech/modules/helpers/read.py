...
TOOLS_DATA_READ = f"""
<u>**ᴛᴏᴏʟs ғᴏʀ {Rzayev.name} ᴀʀᴇ:**</u>
**➻ ᴜsᴇ /ping ғᴏʀ ᴄʜᴇᴄᴋɪɴɢ ᴛʜᴇ ᴘɪɴɢ ᴏғ {Rzayev.name}**
**──────────────**
...
ABOUT_READ = f"""
**➻ [{Rzayev.name}](https://t.me/{Rzayev.username}) ɪs ᴀɴ ᴀɪ ʙᴀsᴇᴅ ᴄʜᴀᴛ-ʙᴏᴛ.**
**➻ [{Rzayev.name}](https://t.me/{Rzayev.username}) ʀᴇᴘʟɪᴇs ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴛᴏ ᴀ ᴜsᴇʀ.**
...
**──────────────**
**➻ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ғᴏʀ ɢᴇᴛᴛɪɴɢ ʙᴀsɪᴄ ʜᴇʟᴩ ᴀɴᴅ ɪɴғᴏ ᴀʙᴏᴜᴛ [{Rzayev.name}](https://t.me/{Rzayev.username})**
"""
